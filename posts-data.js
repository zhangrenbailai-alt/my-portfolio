const POSTS = [
   ...
   { 
    id: "20260630-post1",       // ファイル名から.htmlを除いたもの
    tag: "stamp",               // タグ名
    title: "金色に塗る",  // 記事タイトル
    date: "2026.06.30",          // 日付
    url: "posts/20260630-post1.html"  // ファイルのパス
  },

   { 
    id: "20260629-post2",       // ファイル名から.htmlを除いたもの
    tag: "stamp",               // タグ名
    title: "樹脂粘土で持ち手を作る",  // 記事タイトル
    date: "2026.06.29",          // 日付
    url: "posts/20260629-post2.html"  // ファイルのパス
  },

   { 
    id: "20260629-post1",       // ファイル名から.htmlを除いたもの
    tag: "stamp",               // タグ名
    title: "消しゴムはんこ試し押し",  // 記事タイトル
    date: "2026.06.29",          // 日付
    url: "posts/20260629-post1.html"  // ファイルのパス
  },

   { 
    id: "20260626-post1",       // ファイル名から.htmlを除いたもの
    tag: "stamp",               // タグ名
    title: "消しゴムはんこを彫刻する",  // 記事タイトル
    date: "2026.06.26",          // 日付
    url: "posts/20260626-post1.html"  // ファイルのパス
  },

   { 
    id: "20260625-post1",       // ファイル名から.htmlを除いたもの
    tag: "stamp",               // タグ名
    title: "どんなハンコを作るか",  // 記事タイトル
    date: "2026.06.25",          // 日付
    url: "posts/20260625-post1.html"  // ファイルのパス
  },
